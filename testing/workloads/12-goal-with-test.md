...
1. Agent parses /goal command and creates goal.json via goal-manage.sh
...
8. Agent marks goal as achieved via goal-manage.sh done
9. Agent reports achievement and stops

## Features Tested

- F11: goal-manage.sh create → goal.json written with status "pursuing"
