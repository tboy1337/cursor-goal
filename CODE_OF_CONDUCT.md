...
`cursor-goal` project a harassment-free experience for everyone, regardless
...
reported via
[GitHub Security Advisories for tboy1337/cursor-goal](https://github.com/tboy1337/cursor-goal/security/advisories/new)
or by opening a
[GitHub issue](https://github.com/tboy1337/cursor-goal/issues/new) if the
report does not need to stay private. All complaints will be reviewed and
