...
Current package version is **2.15.0**. The public GitHub tag for this release is **`v2.15.0`**. After tagging, README/install pins work with `git clone --branch v2.15.0`.
