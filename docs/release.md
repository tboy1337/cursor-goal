...
Current package version is **2.16.0**. The public GitHub tag for this release is **`v2.16.0`**. After tagging, README/install pins work with `git clone --branch v2.16.0`.
