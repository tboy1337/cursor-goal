...
Current package version is **2.8.0**. The first public 2.x GitHub tag should be **`v2.8.0`** (until then, docs pins reference this version; only `v1.1.1` may exist on the remote).
