...
Current package version is **2.13.0**. The public GitHub tag for this release is **`v2.13.0`**. After tagging, README/install pins work with `git clone --branch v2.13.0`.
