...
Current package version is **2.14.0**. The public GitHub tag for this release is **`v2.14.0`**. After tagging, README/install pins work with `git clone --branch v2.14.0`.
