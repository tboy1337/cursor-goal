...
Package version **4.0.2** pins the clone branch below. Use it when tag `v4.0.2` exists on [GitHub Releases](https://github.com/tboy1337/cursor-goal/releases). If `git clone --branch` fails, clone `main` with the Quick install steps above ([release.md](release.md)).

```bash
git clone --branch v4.0.2 https://github.com/tboy1337/cursor-goal.git
cd cursor-goal
